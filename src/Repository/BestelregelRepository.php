...
/**
 * @extends ServiceEntityRepository<Bestelregel>
 *
...
class BestelregelRepository extends ServiceEntityRepository
{
    ...
    public function add(Bestelregel $entity, bool $flush = false): void
    {
    ...
    public function remove(Bestelregel $entity, bool $flush = false): void
    {
